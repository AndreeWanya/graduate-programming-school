class Car():
    ...
    def __init__(self, color, autobody, max_speed):
        ...
        self._engine = None                     # Новое из задания 4.1

    def car_painting(self, new_color):
        self._color = new_color

    def car_engine(self, engine):               # Новое из задания 4.1
        self._engine = engine

    def get_engine(self):                       # Новое из задания 4.1
        return self._engine
...
class Engine():
	...
	def get_fuel(self):		# Новое из задания 4.1
		return self._fuel
...
# задание 4.1
my_car.car_engine(my_car_engine)
my_wife_car.car_engine(my_wife_car_engine)

print('Мой автомобиль имеет объем двигателя', my_car.get_engine().get_volume(), 'и ездит на', my_car.get_engine().get_fuel())
print('Автомобиль моей жены ездит на', my_wife_car.get_engine().get_fuel(), 'и имеет мощьнось двигателя в', my_wife_car.get_engine().get_power())
